...
mongoose.connect("mongodb://localhost:27017/congSupply", {
...
congSupply.post(
  ...
  async function (req, res) {
    ...
    if (!errors.isEmpty()) {
      ...
      let saveStatus = await new Order(orderData).save();
      if (saveStatus) {
...
console.log("Start hosting website at port http://localhost:8020...");
